...
const CouponCard = ({coupon}) => {
    const {couponCode,discountPercentage,couponDescription,status}= coupon
    return (
        <div>
            <div
                ...
                <div
                    ...
                    <h1 className="flex justify-center gap-1 mt-6 font-sans antialiased font-normal tracking-normal text-white text-7xl">
                        <span className="mt-2 text-4xl">$</span>{discountPercentage}
